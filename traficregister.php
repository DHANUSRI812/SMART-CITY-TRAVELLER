...
if($connect)
{
				...
				$sqlCheckUname = mysql_query("SELECT * FROM  traficregister WHERE username = '$eemail'");
				...
				else
				{
					...
					$sql_register = mysql_query("INSERT INTO traficregister VALUES ('','$ename','$eemail','$email','$econtact','$epassword')");
