...
if($connect)
{
				...
				$sqlCheckUname = mysql_query("SELECT * FROM  tripregister WHERE username = '$eemail'");
				...
				else
				{
					...
					$sql_register = mysql_query("INSERT INTO tripregister VALUES ('','$ename','$eemail','$email','$econtact','$epassword')");
